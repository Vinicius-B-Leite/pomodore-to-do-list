...
import React, { View, StatusBar, FlatList, KeyboardAvoidingView, ToastAndroid, Platform } from 'react-native'
...
export default function CreateTask() {
    ...
    return (
        <KeyboardAvoidingView enabled={false} style={{flex: 1}} behavior={Platform.OS === "ios" ? "padding" : "height"}
        >
            <Conteiner>
                <StatusBar />
                <ConteinerInput>
